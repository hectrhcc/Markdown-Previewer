    ...
    return (
      <>
       <div className="editor"><h4 style={{margin:"0px", backgroundColor:"#4AA3A3", boxShadow:"0px 0px 10px rgba(0, 0, 0, 0.5)", borderBottom: "1px solid black", padding: "5px"}}>Editor</h4>
        <textarea className="textarea"  style={{display:"flow-root", border: "1px solid black", boxShadow: "0px 0px 10px rgba(0, 0, 0, 0.5)", width:"99%", margin: "0 auto", outline: "none"}}  id="editor"  onChange={this.handleChange} value={this.state.input}/>
      </div>
